  ...
  return (
    ...
    >
      ...
      <button
        ...
        aria-label="Adicionar novo serviço à ordem de serviço"
        className="focus-visible flex items-center gap-2 border-2 border-prim2 py-2 px-4 rounded-md text-lg font-semibold text-prim2 hover:bg-prim2 hover:text-white transition duration-300 ease-in-out cursor-pointer"
      >
